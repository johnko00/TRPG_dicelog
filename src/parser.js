...
(function (root, factory) {
  ...
  function buildRollRecord(item, rollData, context) {
    ...
    return {
      ...
      sourceLogId: context.sourceLogId,
      parserVersion: context.parserVersion == null ? PARSER_VERSION : context.parserVersion,
      lineageId: item.lineageId || context.lineageId || null,
      sourceMessageKey: item.sourceMessageKey || context.sourceMessageKey || null,
      sourceKey: rollData.sourceKey || context.sourceKey || null,
      messageFingerprint: item.messageFingerprint || context.messageFingerprint || null,
      messageOccurrence: item.messageOccurrence == null ? (context.messageOccurrence == null ? null : context.messageOccurrence) : item.messageOccurrence,
